...
export default function SliderProv() {
    return (
        <div className="relative py-8 bg-[#C6441C]">
            {/* Contenedor con gradiente para dar efecto de fade a los lados */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute left-0 w-32 h-full bg-gradient-to-r from-[#C6441C] to-transparent z-10"></div>
                <div className="absolute right-0 w-32 h-full bg-gradient-to-l from-[#C6441C] to-transparent z-10"></div>
            </div>
